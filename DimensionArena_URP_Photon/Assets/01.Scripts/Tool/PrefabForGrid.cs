...
namespace GRITTY
{
    ...
    public class NodeInformation
    {
        ...
        public NodeInformation(bool brown)
        {
            ...
            if(brown)
            {
                basicGroundTexture = BaseGroundTexture.brown;
            }
            else
            {
                basicGroundTexture = BaseGroundTexture.darkbrown;
            }
        ...
        void SetupStyles()
        {
            ...
            // ==========================
            gridSelctedTexture = MakeSelectedTexture2D(gridNormalTexture);
        }
    ...
    public static class BaseGroundTexture
    {
